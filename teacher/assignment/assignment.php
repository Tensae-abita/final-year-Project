...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         ...
         <li class="list-group-item bg-dark"><a href="../teacher.php">Students</a></li>
            ...
            <li class="list-group-item bg-dark"><a href="">Upload Assignment</a></li>
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#home">Assignments you uploaded</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#manage_course">Add Assignments</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#menu2">submitted assignments</a>
  </li>
</ul>
		<!-- Nav tabs ends -->
...
<!-- ========================================================================================================================== -->
  ...
  <div >    <!-- list of users starts -->
                ...
                <p class="ml-5">Assignments you aploaded</p>
                <thead>
                  <tr>
