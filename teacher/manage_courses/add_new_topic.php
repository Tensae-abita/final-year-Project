...
<?php
   ...
   require("../../admin/includes/navbar.php");    //navigation bar included
...
<!-- sidebar starts -->
 ...
 <!-- ===============================================================================================================-->
            ...
            <form  method="POST" action="verify/verify_changes.php" class="ml-3" onsubmit="return validation()">
                ...
                course name:<input type="text" name="coursename" id="coursename" class="form-control" readonly="readonly" value="<?php echo $_GET['course_name'] ?>"> <span id="name_error"></span><br>
