...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark"><a href="">Students and Teachers</a></li>
            ...
            <li class="list-group-item bg-dark"><a href="./assign_teacher.php">Assign Teacher</a></li>
                ...
                <tbody style="">
                   ...
                   <?php 
                     ...
                     $userd=$admin->show_users();
                          ...
                          if($userdata['type']=='Student' ||$userdata['type']=='Teacher'  ){
