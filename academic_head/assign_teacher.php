...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark"><a href="./head.php">Students and Teachers</a></li>
            <!-- <li class="list-group-item bg-dark "><a href="manage_courses/manage_courses.php">Manage Courses</a></li> -->
          
            
            <li class="list-group-item bg-dark"><a href="notice.php">Notice</a></li>
            <li class="list-group-item bg-dark"><a href="">Assign Teacher</a></li>
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#home">Assign Teacher</a>
  </li>
        ...
        <div class="tab-content" id="myTabContent">   <!-- tab content starts -->
          ...
          <div class="tab-pane fade show active p-3" id="one" role="tabpanel" aria-labelledby="one-tab">
            ...
            <div class="card-body col-md-12">
				  ...
				  <div class="card-header bg-danger text-light p-2 cardh2"><h3>ADD NEW User</h3></div>
